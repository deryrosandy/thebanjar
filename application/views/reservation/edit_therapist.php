...
<?php 
	foreach($data_pax as $row_pax) 
	{
		...
		$thr = $row_pax->rpd_therapist;
		$thr_2 = $row_pax->rpd_therapist_2;
	}
?>
...
<div id="page-stats1" class="block-body collapse in">
	<div id="myTabContent" class="tab-content">
			...
			echo form_open('reservation/admin/edit_data_therapist', $attributes);
			...
			echo form_hidden('res_id', $this->uri->segment(4));?>
                <fieldset class="step" id="w2first">
					...
					<div id="outputbox"><input type="hidden" name="therapist" value="<?php echo $thr;?>" id="therapist" /></div>
					<div class="formRow">
					...
					<div id="outputthr"><input type="hidden" name="therapist_2" value="<?php echo $thr_2;?>" id="therapist_2" /></div>
